...
module "eks_managed_node_group" {
  ...
  num_efa_interfaces                 = try(each.value.num_efa_interfaces, var.eks_managed_node_group_defaults.num_efa_interfaces, 2)
...
module "self_managed_node_group" {
  ...
  num_efa_interfaces                 = try(each.value.num_efa_interfaces, var.self_managed_node_group_defaults.num_efa_interfaces, 2)
